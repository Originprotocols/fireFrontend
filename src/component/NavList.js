...
const NavList = () => {
    ...
    useEffect(()=>{
        setSelectedKeys(location.pathname.substr(1,location.pathname.length))
    })
    return (
        <NavListBox>
            <div className="nav-box-box">
                ...
                >
                    ...
                    <div className="logo-box">
                        <a href="http://firedao.co/" target="_blank">  <img className="logo" src={logo} alt="" /></a>
                    </div>
                    ...
                    <div className="lng-choose">
                        <a href="http://apptest.firedao.co/MintPassport" target="_blank">
